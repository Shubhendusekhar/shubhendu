...
<head>
<link rel="icon" href="S3-world.ico" type="image/icon" sizes="16x16">
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1" />
<meta name="viewport" content="width=device-width, initial-scale=1">

<title> S3-WORLD </title>
...
<div class="row">
<div class="col-lg-6">
<span class="logo">S3-WORLD</span></div>
...
?>>BATCHOLOR OF COMPUTER APPLICATION</option>
  <option value="IT" <?php
  if (isset($_GET['branch']))
  {
  if ($_GET['branch'] == "IT")
...
<a href="#" data-toggle="modal" data-target="#login" style="color:red">Admin Login</a></div>
<div class="col-md-3 box">
<span href="#" data-target="#login" style="color:green">Organized by S3-WORLD<br><br></span>
</div>
...
<div class="col-md-2 box">
<a href="about.php" style="color:lightblue;" onmouseover="this.style('color:yellow')" target="new">About</a></div>
